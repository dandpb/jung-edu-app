...
export class WorkflowTemplateManager {
  ...
  async deleteTemplate(templateId: string, userId: string): Promise<void> {
    ...
    // Log activity
    this.logActivity(templateId, template.name, 'deleted', userId);
  }
  ...
  async setTemplatePermission(
    ...
    // Log activity
    this.logActivity(templateId, '', 'permission_granted', grantedBy, {
      targetUser: userId,
      permission
    });
  }
  ...
  async removeTemplatePermission(
    ...
    // Log activity
    this.logActivity(templateId, '', 'permission_removed', requestingUserId, {
