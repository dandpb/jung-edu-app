...
describe('localStorage utilities', () => {
  ...
  beforeEach(() => {
    ...
    if (localStorageMock.getItem && localStorageMock.getItem.mockImplementation) {
      localStorageMock.getItem.mockImplementation((key: string) => store[key] || null);
    }
    if (localStorageMock.setItem && localStorageMock.setItem.mockImplementation) {
      localStorageMock.setItem.mockImplementation((key: string, value: string) => {
        store[key] = value;
      });
    }
    if (localStorageMock.removeItem && localStorageMock.removeItem.mockImplementation) {
