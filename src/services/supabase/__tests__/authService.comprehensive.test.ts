...
jest.mock('../../../config/supabase', () => {
  ...
  const createDatabaseQuery = {
    ...
    mockReturnValue(value: {
      ...
      if (value?.users) {
        this.users.mockImplementation(value.users);
      }
      if (value?.userProfiles) {
        this.userProfiles.mockImplementation(value.userProfiles);
      }
      if (value?.userSessions) {
        this.userSessions.mockImplementation(value.userSessions);
      }
      return this;
    },
    mockReset() {
      this.users.mockReset();
      this.userProfiles.mockReset();
      this.userSessions.mockReset();
      return this;
    }
  };
...
describe('SupabaseAuthService', () => {
  ...
  beforeEach(() => {
    ...
    mockCreateDatabaseQuery.mockReset();
  ...
  describe('Auth State Change Handling', () => {
    ...
    it('should ignore unknown events', () => {
      expect(() => mockSessionCallback('UNKNOWN_EVENT' as any, mockSession)).not.toThrow();
    });
  });
