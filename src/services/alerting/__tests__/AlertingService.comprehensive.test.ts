...
// Mock AlertingEngine
jest.mock('../AlertingEngine', () => ({
  AlertingEngine: jest.fn().mockImplementation(() => ({
    on: jest.fn(),
    stop: jest.fn(),
...
describe('AlertingService', () => {
  ...
  let mockEngine: jest.Mocked<AlertingEngine>;
  ...
  beforeEach(() => {
    ...
    const MockedEngine = AlertingEngine as jest.MockedClass<typeof AlertingEngine>;
    mockEngine = new MockedEngine() as jest.Mocked<AlertingEngine>;
    
    service = new AlertingService(defaultConfig);
  });
  ...
  describe('Monitoring Integration', () => {
    ...
    it('should not setup real-time handlers in polling-only mode', () => {
      const eventSpy = jest.spyOn(mockMonitoringService, 'on');
      service.connectToMonitoring(mockMonitoringService);
  ...
  describe('Event Handling', () => {
    ...
    it('should determine severity from event type', () => {
      ...
      const testCases = [
        ...
        { type: 'warning', expected: 'medium' },
        { type: 'performance_degradation', expected: 'medium' },
        { type: 'info', expected: 'low' }
      ];
