...
describe('Navigation Component', () => {
  test('renders all navigation links', () => {
    ...
    expect(screen.getByText("Jung's Psychology")).toBeInTheDocument();
  ...
  test('highlights active link based on current route', () => {
    ...
    const mindMapLink = screen.getByText('Mind Map').closest('a');
  ...
  test('logo links to dashboard', () => {
    ...
    const logo = screen.getByText("Jung's Psychology").closest('a');
