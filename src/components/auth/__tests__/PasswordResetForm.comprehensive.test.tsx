...
describe('PasswordResetForm Component', () => {
  ...
  describe('Initial Rendering', () => {
    ...
    it('should display authentication errors', () => {
      const error = new AuthError('AUTH_USER_NOT_FOUND', 'User not found');
    ...
    const errorScenarios = [
      {
        ...
        error: new AuthError('AUTH_USER_NOT_FOUND', 'No user found with this email address')
      },
      {
        name: 'rate limit error',
        error: new AuthError('RATE_LIMIT_EXCEEDED', 'Too many password reset requests. Please try again later.')
      },
      {
        name: 'server error',
        error: new AuthError('INTERNAL_ERROR', 'Internal server error')
      }
    ];
