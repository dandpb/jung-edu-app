...
describe('index.tsx', () => {
  ...
  test('renders in StrictMode', () => {
    ...
    expect(renderCall.type).toBe(React.StrictMode);
    expect(renderCall.props.children).toBeDefined();
    expect(renderCall.props.children.type).toBeDefined();
  ...
  test('renders exactly one App component', () => {
    ...
    // Check that StrictMode has one child which is the App component
    expect(renderCall.type).toBe(React.StrictMode);
    expect(renderCall.props.children).toBeDefined();
    expect(renderCall.props.children.type).toBeDefined();
    // The mocked App component is a function
    expect(typeof renderCall.props.children.type).toBe('function');
  });
});