...
describe('useMonitoringWebSocket', () => {
  ...
  describe('Hook Initialization and Configuration', () => {
    it('should initialize with default configuration', () => {
      ...
      expect(mockIo).toHaveBeenCalledWith('ws://test.localhost:3001', {
  ...
  describe('Mock Data Simulation', () => {
    it('should generate mock data when WebSocket is not connected', async () => {
      renderHook(() => useMonitoringWebSocket({
        onMetricsUpdate: mockOnMetricsUpdate,
      }));
    ...
    it('should stop mock data simulation when connected', async () => {
      renderHook(() => useMonitoringWebSocket({
        onMetricsUpdate: mockOnMetricsUpdate,
      }));
    ...
    it('should generate realistic mock data variations', async () => {
      renderHook(() => useMonitoringWebSocket({
        onMetricsUpdate: mockOnMetricsUpdate,
      }));
  ...
  describe('Cleanup and Memory Management', () => {
    ...
    it('should clear mock data intervals on cleanup', () => {
      const { unmount } = renderHook(() => useMonitoringWebSocket({
        onMetricsUpdate: mockOnMetricsUpdate,
      }));
