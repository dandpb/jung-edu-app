...
exports.exampleUsage = exports.virtualClassroomWorkflow = exports.courseCompletionWorkflow = exports.adaptiveLearningWorkflow = exports.quizGradingWorkflow = exports.studentOnboardingWorkflow = void 0;
exports.executeEducationalWorkflow = executeEducationalWorkflow;
// 1. Student Onboarding Workflow
exports.studentOnboardingWorkflow = {
...
exports.adaptiveLearningWorkflow = {
...
exports.courseCompletionWorkflow = {
...
exports.virtualClassroomWorkflow = {
...
async function executeEducationalWorkflow(workflowService, workflow, inputData) {
    try {
        console.log(`🚀 Executing workflow: ${workflow.name}`);
        const result = await workflowService.executeWorkflow(workflow, inputData, {
            priority: 'high',
...
`;
//# sourceMappingURL=educational-workflows.js.map